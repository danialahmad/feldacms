$(document).ready(function() {
	...
	$.get(contextroot + "latestCasesBySupervisor", function(data) {
		var arr = new Array();
		...
		/**	setInterval(function() {				
			...
			$.get(contextroot + "dashboard/caseInfoBySupervisor", function(data) {
			...
			$.get(contextroot + "dashboard/caseInfoByPriorityBySupervisor", function(data) {
				var arr = new Array();
				var dataArr = [];
				$.each(data.aaData, function( index, value ) {
					var priority="";
