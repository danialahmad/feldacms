$(document).ready(function(){
           ...
           "aoColumnDefs": [
                            {
                                ...
                                "fnRender" : function ( oObj ) {
                               	return '<a class="modalAct" href="'+contextPath+'administration/md/ticketCategory/edit/'+oObj.aData.id+'">'+oObj.aData.name+'</a>';
                                },
                            ...
                            },
                            {
                                "bUseRendered": false,
                                "fnRender" : function ( oObj ) {
                               	return '<button class="btn btn-mini btn-danger btn-block remove" href="'+contextPath+'administration/md/ticketCategory/delete/'+oObj.aData.id+'">Remove</button>';
                                },
		...
		"fnServerParams" : function(aoData) {
			//if($("#username").val()!=null){
				aoData.push(
					...
					{"name": "ticketGroup.id", "value" : $("#ticketGroup").val() }
				);
			//}
		},
	...
	$("#btn-open-setting").click(function(e){
		...
		$("#formModal").modal({
			show:true,
			remote:contextPath+"administration/md/ticketCategory/add"
		}).css({
