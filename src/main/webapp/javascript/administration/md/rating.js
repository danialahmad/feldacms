$(document).ready(function(){
           ...
           "aoColumnDefs": [
                            {
                                ...
                                "fnRender" : function ( oObj ) {
                                	return '<a class="modalAct" href="'+contextPath+'administration/md/rating/edit/'+oObj.aData.id+'">'+oObj.aData.name+'</a>';
                                },
                            ...
                            },
                            {
                                "bUseRendered": false,
                                "fnRender" : function ( oObj ) {
                               	return '<button class="btn btn-mini btn-danger btn-block remove" href="'+contextPath+'administration/md/rating/delete/'+oObj.aData.id+'">Remove</button>';
                                },
	...
	$("#btn-open-setting").click(function(e){
		...
		$("#formModal").modal({
			show:true,
			remote:contextPath+"administration/md/rating/add"
		}).css({
