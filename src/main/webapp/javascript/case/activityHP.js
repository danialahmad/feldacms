$(document).ready(function(){
	...
	$("#btn-open-setting").click(function(e){
		...
		$("#activityModal").modal({
			show:true,
			remote:contextPath+"case/activity/add/"+$("#id").val()+"#viewComplaint"
		}).css({
	...
	var dataTableOption = $("#list-activities").dataTable({
        ...
        "bSort": false,
        "bFilter": false,
        "sAjaxSource": contextPath+"case/list/activitiesHD/"+$("#id").val(),
        "aoColumns": [
           ...
           "aoColumnDefs": [
                            {
                                ...
                                "fnRender" : function ( oObj ) {
                                	var a=oObj.aData.createBy+'<br/>'+oObj.aData.group;
                               	return a;
                                },
