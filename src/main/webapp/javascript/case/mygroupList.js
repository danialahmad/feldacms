           ...
           "aoColumnDefs": [
                            {
                                ...
                                "fnRender" : function ( oObj ) {
                                	return '<a href="'+contextPath+'case/assignment/view/'+oObj.aData.id+'/'+oObj.aData.assignmentId+'">'+oObj.aData.id+'</a>';
                                },
                            ...
                            },
                            {
                                "bUseRendered": false,
                                "fnRender" : function ( oObj ) {
                               	return '<a class="logClick icon" href="'+contextPath+'eventLog/'+oObj.aData.id+'"><span class="i-cabinet text-info"></span></a>';
                                },
